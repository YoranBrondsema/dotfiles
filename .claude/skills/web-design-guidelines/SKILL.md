...
description: Check web interfaces against our design guidelines. Use when asked to "review my UI", "check accessibility", "audit design", "review UX", "check my site against best practices", or "apply web design guidelines".
---

# Web Design Guidelines

Review web interfaces against our comprehensive web design guidelines and propose fixes.

## How It Works

1. Read the user's code (components, CSS, HTML)
2. Check against web design guidelines (interactions, animations, layout, content, forms, performance, design, copywriting)
...
1. Fetch the guidelines from [guidelines.md](guidelines.md)
...
Reviewed {N} files against web design guidelines.
